...
{    
    ...
    //On met l'image en BG de la table view
    self.tableView.backgroundView = [[[UIImageView alloc] initWithImage:[UIImage imageNamed:@"newsListBG.png"]]autorelease];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.resumeLabel.text = [NSString stringWithFormat:@"%@ - %@ ", entry.author, entry.pubDate];
    //    NSLog(@"%@", entry.author);
